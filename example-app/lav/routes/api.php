...
Route::get('/mahasiswa/{id}', [studentApiController::class, 'getById']);    // Berdasarkan id
Route::get('/mahasiswa/by_nim/{nim}', [studentApiController::class, 'getByNim']);   // Berdasarkan nim

// Menambah data siswa melalui API
Route::post('/mahasiswa', [studentApiController::class, 'save']);

// Mengubah data siswa melalui API berdasarkan id
